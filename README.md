 ...
 * Je souhaite ajouter une nouvelle tour peu chère le `Missile` (cout = 60) qui va tirer à une distance courte (20), l'interface graphique devrait être revue, elle aussi, pour intégrer cette nouvelle tour.
 ...
 * Je souhaite ajouter un second niveau dans le jeu, mais je ne suis pas encore sûr de tout ce que je veux à l'intérieur, nous pouvons en discuter ensemble.
   * lorsque le 1er niveau est terminé, les compteurs sont remis à zéro et le niveau 2 commence,
   * le chemin suivi par les enemis doit être différent.
   * 1 nouvel enemi fait son apparition. (caractéristiques à demander au client)
